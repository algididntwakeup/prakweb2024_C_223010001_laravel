...
@forelse ( $posts as $post )
          ...
          <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <a href="/posts/{{ $post['slug'] }}" class="hover:underline">
              <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $post->tittle }}</h2>
            </a>
              ...
              <div class="flex justify-between items-center">
                <a href="/posts?author=/{{ $post->author->username }}">
                  ...
                  <a href="/posts/{{ $post['slug'] }}" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline text-sn">
                      Read more
...
@empty
  <p class="font-semibolf text-xl my-4">Article not found!</p>
